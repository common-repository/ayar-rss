...
//$pattern=array("/Ayar/", "/Ayar Takhu/", "/Ayar Juno/");# 
//$replacement = array("Zawgyi one","Zawgyi one","Zawgyi one"); # 
//$content=preg_replace($pattern, $replacement, $content);
$pattern="/font-family:(.*);/";
$replacement="font-family:Zawgyi One;";
$content=preg_replace($pattern, $replacement, $content);

//Uncomment if you want to declare font for whole content
$pattern="/(.*)/";
$replacement = "<span style=\"font-family:zawgyi one\">\${0}</span>";
$content=preg_replace($pattern, $replacement, $content);
return $content;
}
add_filter("the_title_rss","ayar2zg");
add_filter("wp_title_rss","ayar2zg");
add_filter("bloginfo_rss","ayar2zg");
add_filter("the_excerpt_rss","ayar2zg");
add_filter("the_content_feed","ayar2zg");
add_filter("comment_text_rss","ayar2zg");
add_filter("comment_text","ayar2zg");
